...
import static com.google.android.exoplayer3.Renderer.MSG_SET_AUDIO_ATTRIBUTES;
import static com.google.android.exoplayer3.Renderer.MSG_SET_AUDIO_SESSION_ID;
import static com.google.android.exoplayer3.Renderer.MSG_SET_AUX_EFFECT_INFO;
import static com.google.android.exoplayer3.Renderer.MSG_SET_CAMERA_MOTION_LISTENER;
import static com.google.android.exoplayer3.Renderer.MSG_SET_SCALING_MODE;
import static com.google.android.exoplayer3.Renderer.MSG_SET_SKIP_SILENCE_ENABLED;
import static com.google.android.exoplayer3.Renderer.MSG_SET_VIDEO_FRAME_METADATA_LISTENER;
import static com.google.android.exoplayer3.Renderer.MSG_SET_VIDEO_OUTPUT;
import static com.google.android.exoplayer3.Renderer.MSG_SET_VOLUME;
...
import com.google.android.exoplayer3.analytics.AnalyticsListener;
import com.google.android.exoplayer3.audio.AudioAttributes;
import com.google.android.exoplayer3.audio.AudioListener;
import com.google.android.exoplayer3.audio.AudioRendererEventListener;
import com.google.android.exoplayer3.audio.AuxEffectInfo;
...
import com.google.android.exoplayer3.device.DeviceInfo;
import com.google.android.exoplayer3.device.DeviceListener;
...
import com.google.android.exoplayer3.metadata.MetadataOutput;
...
import com.google.android.exoplayer3.source.ShuffleOrder;
...
import com.google.android.exoplayer3.upstream.BandwidthMeter;
...
import com.google.android.exoplayer3.util.ConditionVariable;
import com.google.android.exoplayer3.util.Log;
import com.google.android.exoplayer3.util.PriorityTaskManager;
import com.google.android.exoplayer3.util.Util;
import com.google.android.exoplayer3.video.VideoDecoderOutputBufferRenderer;
import com.google.android.exoplayer3.video.VideoFrameMetadataListener;
import com.google.android.exoplayer3.video.VideoListener;
import com.google.android.exoplayer3.video.VideoRendererEventListener;
import com.google.android.exoplayer3.video.VideoSize;
import com.google.android.exoplayer3.video.spherical.CameraMotionListener;
import com.google.android.exoplayer3.video.spherical.SphericalGLSurfaceView;
