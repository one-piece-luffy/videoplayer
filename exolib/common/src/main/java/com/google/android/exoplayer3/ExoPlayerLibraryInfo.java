...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.exoplayer3.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.exoplayer3.util.TraceUtil}
   * trace enabled.
   */
