 ...
 * </pre>
 */
public class AvLiveControlView extends FrameLayout implements InterControlView, View.OnClickListener {
    ...
    public AvLiveControlView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public AvLiveControlView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AvLiveControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        View view = LayoutInflater.from(getContext()).inflate(
                R.layout.av_video_player_live, this, true);
