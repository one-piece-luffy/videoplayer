...
import static com.google.android.exoplayer3.util.FileTypes.inferFileTypeFromResponseHeaders;
import static com.google.android.exoplayer3.util.FileTypes.inferFileTypeFromUri;

import android.net.Uri;
import androidx.annotation.Nullable;
import com.google.android.exoplayer3.extractor.amr.AmrExtractor;
import com.google.android.exoplayer3.extractor.flac.FlacExtractor;
import com.google.android.exoplayer3.extractor.flv.FlvExtractor;
import com.google.android.exoplayer3.extractor.jpeg.JpegExtractor;
import com.google.android.exoplayer3.extractor.mkv.MatroskaExtractor;
import com.google.android.exoplayer3.extractor.mp3.Mp3Extractor;
import com.google.android.exoplayer3.extractor.mp4.FragmentedMp4Extractor;
import com.google.android.exoplayer3.extractor.mp4.Mp4Extractor;
import com.google.android.exoplayer3.extractor.ogg.OggExtractor;
import com.google.android.exoplayer3.extractor.ts.Ac3Extractor;
import com.google.android.exoplayer3.extractor.ts.Ac4Extractor;
import com.google.android.exoplayer3.extractor.ts.AdtsExtractor;
import com.google.android.exoplayer3.extractor.ts.DefaultTsPayloadReaderFactory;
...
import com.google.android.exoplayer3.extractor.wav.WavExtractor;
import com.google.android.exoplayer3.util.FileTypes;
import com.google.android.exoplayer3.util.TimestampAdjuster;
  ...
  static {
    ...
    try {
      ...
      boolean isFlacNativeLibraryAvailable =
          Boolean.TRUE.equals(
              Class.forName("com.google.android.exoplayer3.ext.flac.FlacLibrary")
                  .getMethod("isAvailable")
                  .invoke(/* obj= */ null));
      if (isFlacNativeLibraryAvailable) {
        flacExtensionExtractorConstructor =
            Class.forName("com.google.android.exoplayer3.ext.flac.FlacExtractor")
