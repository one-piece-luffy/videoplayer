...
public class SourceCreator {
    ...
    public BaseResponse createM3U8SegResponseNew(HttpRequest request, String parentUrl, String videoUrl, Map<String, String> headers, long time, String fileName) throws Exception {
        return new M3U8SegResponseNew(request, parentUrl, videoUrl, headers, time, fileName);
    }

//    public VideoCacheTask createM3U8CacheTaskNew(VideoCacheInfo cacheInfo, Map<String, String> headers, M3U8 m3u8, Handler handler) {
