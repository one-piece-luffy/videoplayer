 ...
 * </pre>
 */
public class AvStoreBottomView extends FrameLayout implements InterControlView,
    ...
    public AvStoreBottomView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public AvStoreBottomView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AvStoreBottomView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected int getLayoutId() {
        return R.layout.av_video_player_store_bottom;
    }
