 ...
 */
package com.google.android.exoplayer3.mediacodec;

import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.DISCARD_REASON_OPERATING_RATE_CHANGED;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.DISCARD_REASON_WORKAROUND;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.REUSE_RESULT_NO;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITHOUT_RECONFIGURATION;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_FLUSH;
import static com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_RECONFIGURATION;
import static com.google.android.exoplayer3.source.SampleStream.FLAG_OMIT_SAMPLE_DATA;
import static com.google.android.exoplayer3.source.SampleStream.FLAG_PEEK;
import static com.google.android.exoplayer3.source.SampleStream.FLAG_REQUIRE_FORMAT;
import static com.google.android.exoplayer3.util.Assertions.checkNotNull;
...
import com.google.android.exoplayer3.BaseRenderer;
...
import com.google.android.exoplayer3.FormatHolder;
import com.google.android.exoplayer3.decoder.DecoderCounters;
import com.google.android.exoplayer3.decoder.DecoderInputBuffer;
import com.google.android.exoplayer3.decoder.DecoderInputBuffer.InsufficientCapacityException;
import com.google.android.exoplayer3.decoder.DecoderReuseEvaluation;
import com.google.android.exoplayer3.decoder.DecoderReuseEvaluation.DecoderDiscardReasons;
import com.google.android.exoplayer3.drm.DrmSession;
import com.google.android.exoplayer3.drm.DrmSession.DrmSessionException;
import com.google.android.exoplayer3.drm.ExoMediaCrypto;
import com.google.android.exoplayer3.drm.FrameworkMediaCrypto;
import com.google.android.exoplayer3.mediacodec.MediaCodecUtil.DecoderQueryException;
import com.google.android.exoplayer3.source.MediaPeriod;
import com.google.android.exoplayer3.source.SampleStream;
import com.google.android.exoplayer3.source.SampleStream.ReadDataResult;
import com.google.android.exoplayer3.source.SampleStream.ReadFlags;
import com.google.android.exoplayer3.util.Assertions;
import com.google.android.exoplayer3.util.Log;
import com.google.android.exoplayer3.util.MimeTypes;
import com.google.android.exoplayer3.util.NalUnitUtil;
import com.google.android.exoplayer3.util.TimedValueQueue;
import com.google.android.exoplayer3.util.TraceUtil;
