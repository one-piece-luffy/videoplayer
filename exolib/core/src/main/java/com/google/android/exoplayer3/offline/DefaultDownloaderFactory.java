  ...
  private static SparseArray<Constructor<? extends Downloader>> createDownloaderConstructors() {
    ...
    try {
      array.put(
          ...
          getDownloaderConstructor(
              Class.forName("com.google.android.exoplayer3.source.dash.offline.DashDownloader")));
    ...
    try {
      array.put(
          C.TYPE_HLS,
          getDownloaderConstructor(
              Class.forName("com.google.android.exoplayer3.source.hls.offline.HlsDownloader")));
    } catch (ClassNotFoundException e) {
    ...
    try {
      array.put(
          ...
          getDownloaderConstructor(
              Class.forName(
                      "com.google.android.exoplayer3.source.smoothstreaming.offline.SsDownloader")));
    } catch (ClassNotFoundException e) {
