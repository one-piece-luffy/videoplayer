...
import com.google.android.exoplayer3.extractor.DummyTrackOutput;
import com.google.android.exoplayer3.extractor.Extractor;
import com.google.android.exoplayer3.extractor.ExtractorOutput;
import com.google.android.exoplayer3.extractor.SeekMap;
import com.google.android.exoplayer3.extractor.TrackOutput;
import com.google.android.exoplayer3.metadata.Metadata;
import com.google.android.exoplayer3.metadata.emsg.EventMessage;
import com.google.android.exoplayer3.metadata.emsg.EventMessageDecoder;
...
import com.google.android.exoplayer3.source.SampleQueue;
import com.google.android.exoplayer3.source.SampleQueue.UpstreamFormatChangedListener;
...
import com.google.android.exoplayer3.source.chunk.Chunk;
import com.google.android.exoplayer3.source.chunk.MediaChunkIterator;
import com.google.android.exoplayer3.trackselection.ExoTrackSelection;
import com.google.android.exoplayer3.upstream.Allocator;
import com.google.android.exoplayer3.upstream.DataReader;
...
import com.google.android.exoplayer3.util.ExoConstants;
import com.google.android.exoplayer3.util.Log;
import com.google.android.exoplayer3.util.MimeTypes;
import com.google.android.exoplayer3.util.ParsableByteArray;
...
import static com.google.android.exoplayer3.source.hls.HlsChunkSource.CHUNK_PUBLICATION_STATE_PUBLISHED;
import static com.google.android.exoplayer3.source.hls.HlsChunkSource.CHUNK_PUBLICATION_STATE_REMOVED;
...
/* package */ final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>,
  ...
  public LoadErrorAction onLoadError(
    ...
    if (error.getMessage() != null && error.getMessage().contains(ExoConstants.ERROR_CANNOT_SYGN)) {
    ...
    if (isMediaChunk && error instanceof HttpDataSource.InvalidResponseCodeException) {
      int responseCode = ((HttpDataSource.InvalidResponseCodeException) error).responseCode;
      if (responseCode == 403) {
//        // According to RFC 8216, Section 6.2.6 a server should respond with an HTTP 404 (Not found)
//        // for requests of hinted parts that are replaced and not available anymore. We've seen test
