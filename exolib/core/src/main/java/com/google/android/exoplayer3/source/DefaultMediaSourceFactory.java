...
import com.google.android.exoplayer3.source.ads.AdsLoader;
import com.google.android.exoplayer3.source.ads.AdsMediaSource;
 ...
 *       com.google.android.exoplayer3.extractor.DefaultExtractorsFactory} or the {@link
  ...
  private static SparseArray<MediaSourceFactory> loadDelegates(
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.google.android.exoplayer3.source.dash.DashMediaSource$Factory")
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName(
                  "com.google.android.exoplayer3.source.smoothstreaming.SsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_SS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.google.android.exoplayer3.source.hls.HlsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_HLS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.google.android.exoplayer3.source.rtsp.RtspMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
