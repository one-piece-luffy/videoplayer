...
import com.baofu.videocache.common.ProxyMessage;
...
import com.baofu.videocache.okhttp.IHttpPipelineListener;
import com.baofu.videocache.okhttp.NetworkConfig;
import com.baofu.videocache.okhttp.OkHttpManager;
import com.baofu.videocache.proxy.LocalProxyVideoServer;
import com.baofu.videocache.task.M3U8CacheTask;
import com.baofu.videocache.task.Mp4CacheTask;
import com.baofu.videocache.task.VideoCacheTask;
...
public class VideoProxyCacheManager {
    ...
    public void startRequestVideoInfo(String videoUrl, Map<String, String> headers, Map<String, Object> extraParams) {
        ...
        if (videoCacheInfo == null) {
            ...
            Log.e(TAG,"videoCacheInfo not null");
