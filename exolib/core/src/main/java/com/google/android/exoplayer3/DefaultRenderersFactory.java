...
import com.google.android.exoplayer3.audio.AudioCapabilities;
import com.google.android.exoplayer3.audio.AudioRendererEventListener;
import com.google.android.exoplayer3.audio.AudioSink;
import com.google.android.exoplayer3.audio.DefaultAudioSink;
import com.google.android.exoplayer3.audio.DefaultAudioSink.DefaultAudioProcessorChain;
import com.google.android.exoplayer3.audio.MediaCodecAudioRenderer;
...
import com.google.android.exoplayer3.metadata.MetadataRenderer;
import com.google.android.exoplayer3.text.TextOutput;
import com.google.android.exoplayer3.text.TextRenderer;
import com.google.android.exoplayer3.trackselection.TrackSelector;
import com.google.android.exoplayer3.util.Log;
import com.google.android.exoplayer3.video.MediaCodecVideoRenderer;
import com.google.android.exoplayer3.video.VideoRendererEventListener;
import com.google.android.exoplayer3.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer3.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              com.google.android.exoplayer3.video.VideoRendererEventListener.class,
              int.class);
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer3.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer3.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer3.audio.AudioRendererEventListener.class,
              com.google.android.exoplayer3.audio.AudioSink.class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer3.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer3.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.exoplayer3.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer3.audio.AudioRendererEventListener.class,
