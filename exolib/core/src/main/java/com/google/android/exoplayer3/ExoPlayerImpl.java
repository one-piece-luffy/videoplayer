...
import com.google.android.exoplayer3.source.MediaSource.MediaPeriodId;
...
import com.google.android.exoplayer3.trackselection.TrackSelectorResult;
...
import com.google.android.exoplayer3.util.HandlerWrapper;
import com.google.android.exoplayer3.util.ListenerSet;
...
/* package */ final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
  ...
  public ExoPlayerImpl(
    ...
    this.mplayerForListeners = wrappingPlayer != null ? wrappingPlayer : this;
    listeners =
        new ListenerSet<>(
            applicationLooper,
            clock,
            (listener, flags) -> listener.onEvents(mplayerForListeners, new Events(flags)));
    ...
    if (analyticsCollector != null) {
      analyticsCollector.setPlayer(mplayerForListeners, applicationLooper);
  ...
  private void updatePlaybackInfo(
    ...
    if (previousPlaybackInfo.playbackError != newPlaybackInfo.playbackError
      ...
      try {
        ioException = newPlaybackInfo.playbackError.getSourceException();
      }catch (Exception e){
//        e.printStackTrace();
      }
      ...
      } else if (ioException != null && ioException instanceof HttpDataSource.InvalidResponseCodeException) {
        int responseCode = ((HttpDataSource.InvalidResponseCodeException) ioException).responseCode;
        if (responseCode == ExoConstants.HTTP_403) {
          //todo
          long position = mplayerForListeners.getCurrentPosition();
          try {
...
//        long position = mplayerForListeners.getCurrentPosition();
//        try {
//          mplayerForListeners.seekTo(position + 4000);
//          mplayerForListeners.prepare();
//        } catch (Exception e) {
//          e.printStackTrace();
//        }
