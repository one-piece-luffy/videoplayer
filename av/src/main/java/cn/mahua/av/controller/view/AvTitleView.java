 ...
 * </pre>
 */
public class AvTitleView extends FrameLayout implements InterControlView, View.OnClickListener {
    ...
    public AvTitleView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public AvTitleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AvTitleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        View view = LayoutInflater.from(mContext).inflate(
                R.layout.av_video_player_top, this, true);
    ...
    private void initFindViewById(View view) {
        mLlTitleContainer = view.findViewById(R.id.title_layout);
